...
NDefines.NBuildings.SUPPLY_PORT_LEVEL_THROUGHPUT = 4 --3
...
--NDefines.NDiplomacy.TENSION_DECAY_DAILY = 0.01; --0.005
...
NDefines.NDiplomacy.TENSION_NO_CB_WAR = 20; --10
NDefines.NDiplomacy.TENSION_CB_WAR = 14; --7
...
-- Resistance
NDefines.NResistance.RESISTANCE_TARGET_BASE = 25
NDefines.NResistance.RESISTANCE_TARGET_MODIFIER_IS_AT_PEACE  = -10
NDefines.NResistance.RESISTANCE_TARGET_MODIFIER_HAS_CLAIM = -5
