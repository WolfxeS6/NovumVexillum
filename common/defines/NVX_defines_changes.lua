...
NDefines.NGraphics.VICTORY_POINT_MAP_ICON_AFTER = {0, 30, 50};
NDefines.NGraphics.VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = { 100, 150, 400 };
NDefines.NGraphics.VICTORY_POINT_MAP_ICON_TEXT_CUTOFF_MIN = 50;
NDefines.NGraphics.VICTORY_POINT_MAP_ICON_DOT_CUTOFF_MIN = 70;
-- Designer
